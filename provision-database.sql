...
CREATE TABLE Subscriber (SIMCARD VARCHAR(22), MSISDN VARCHAR(15), deviceType VARCHAR(30), state VARCHAR(30), PRIMARY KEY (SIMCARD));
...
DROP TABLE IF EXISTS MSISDNStatus;
CREATE DATABASE MSISDNStatus;
CREATE TABLE Status (SIMCARD VARCHAR(30) PRIMARY KEY, status BOOLEAN);
